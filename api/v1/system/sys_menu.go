...
// @Success   200   {object}  response.Response{data=systemRes.SysMenusResponse,msg=string}  "获取学生动态路由,返回包括系统菜单详情列表"
...
// @Produce   application/json
// @Param     data  body      request.Empty                                                      true  "空"
// @Success   200   {object}  response.Response{data=systemRes.SysBaseMenusResponse,msg=string}  "获取学生动态路由,返回包括系统菜单列表"
