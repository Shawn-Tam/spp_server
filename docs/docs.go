    ...
    "paths": {
        ...
        "/base/login": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "返回包括学生信息,token,过期时间",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/menu/getBaseMenuTree": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "获取学生动态路由,返回包括系统菜单列表",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/menu/getMenu": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "获取学生动态路由,返回包括系统菜单详情列表",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/user/getUserList": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "分页获取学生列表,返回包括列表,总数,页码,每页数量",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
