...
func (i *initApi) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysApi{
		{ApiGroup: "base", Method: "POST", Path: "/base/login", Description: "学生登录(必选)"},

		{ApiGroup: "jwt", Method: "POST", Path: "/jwt/jsonInBlacklist", Description: "jwt加入黑名单(退出，必选)"},

		{ApiGroup: "系统学生", Method: "DELETE", Path: "/user/deleteUser", Description: "删除学生"},
		{ApiGroup: "系统学生", Method: "POST", Path: "/user/admin_register", Description: "学生注册"},
		{ApiGroup: "系统学生", Method: "POST", Path: "/user/getUserList", Description: "获取学生列表"},
		{ApiGroup: "系统学生", Method: "PUT", Path: "/user/setUserInfo", Description: "设置学生信息"},
		{ApiGroup: "系统学生", Method: "PUT", Path: "/user/setSelfInfo", Description: "设置自身信息(必选)"},
		{ApiGroup: "系统学生", Method: "GET", Path: "/user/getUserInfo", Description: "获取自身信息(必选)"},
		{ApiGroup: "系统学生", Method: "POST", Path: "/user/setUserAuthorities", Description: "设置权限组"},
		{ApiGroup: "系统学生", Method: "POST", Path: "/user/changePassword", Description: "修改密码（建议选择)"},
		{ApiGroup: "系统学生", Method: "POST", Path: "/user/setUserAuthority", Description: "修改学生角色(必选)"},
		{ApiGroup: "系统学生", Method: "POST", Path: "/user/resetPassword", Description: "重置学生密码"},
		...
		{ApiGroup: "菜单", Method: "POST", Path: "/menu/getBaseMenuTree", Description: "获取学生动态路由"},
