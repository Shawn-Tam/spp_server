...
func (i *initAuthority) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysAuthority{
		{AuthorityId: 888, AuthorityName: "普通学生", ParentId: utils.Pointer(0), DefaultRouter: "dashboard"},
		{AuthorityId: 9528, AuthorityName: "测试角色", ParentId: utils.Pointer(0), DefaultRouter: "dashboard"},
		{AuthorityId: 8881, AuthorityName: "普通学生子角色", ParentId: utils.Pointer(888), DefaultRouter: "dashboard"},
	}
